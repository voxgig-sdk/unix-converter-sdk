...
class UnixConverterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnixConverterTestRunner.getenv("UNIXCONVERTER_TEST_LIVE")
        override = UnixConverterTestRunner.getenv("UNIXCONVERTER_TEST_OVERRIDE")
        ...
        explain = UnixConverterTestRunner.getenv("UNIXCONVERTER_TEST_EXPLAIN")
