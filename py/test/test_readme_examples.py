# UnixConverter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UnixConverterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UnixConverterSDK(...) and UnixConverterSDK.test(...) become
#      UnixConverterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "unixconverter_sdk"
_SDK_CLASS = "UnixConverterSDK"
