...
from unixconverter_sdk.utility import register

# Load features
from unixconverter_sdk.feature.base_feature import UnixConverterBaseFeature
from unixconverter_sdk.features import _has_feature, _make_feature
...
class UnixConverterSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = UnixConverterUtility()
        self._utility = utility

        from unixconverter_sdk.config import shared_config
    ...
    def get_utility(self):
        return UnixConverterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UnixConverterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Conversion(self, data=None) -> "ConversionEntity":
        ...
        from unixconverter_sdk.entity.conversion_entity import ConversionEntity
