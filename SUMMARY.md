...
| --- | --- | --- | --- |
| Conversion | `load` | `GET /convert` | See reference |

## Connect to the API

- Production server: `https://unixonvert.api/v1`
...
- `unix-converter_list`: List records for an entity. No active entity supports this operation.
- `unix-converter_load`: Load one record for an entity. Supported entities: `conversion`.
