...
class UnixConverterSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = UnixConverterHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = UnixConverterHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!UnixConverterFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, UnixConverterFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return UnixConverterUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = UnixConverterHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = UnixConverterHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = UnixConverterHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new UnixConverterError($op . "_allow",
                "UnixConverterSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = UnixConverterHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new UnixConverterError("graphql_error",
                "UnixConverterSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Conversion($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_conversion === null) {
                $this->_conversion = new ConversionEntity($this, null);
            }
            return $this->_conversion;
        }
        return new ConversionEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new UnixConverterSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
