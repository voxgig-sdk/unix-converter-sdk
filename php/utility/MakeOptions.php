...
// UnixConverter SDK utility: make_options

class UnixConverterMakeOptions
{
    ...
    public static function call(UnixConverterContext $ctx): array
    {
        ...
        //
        // `UnixConverterSchema::optspec()` is built from the model:
        ...
        $optspec = UnixConverterSchema::optspec();
