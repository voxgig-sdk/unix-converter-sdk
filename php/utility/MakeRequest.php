...
// UnixConverter SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class UnixConverterMakeRequest
{
    public static function call(UnixConverterContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new UnixConverterResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new UnixConverterResponse($fetched);
        } else {
