...
// UnixConverter SDK utility: fetcher

class UnixConverterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UnixConverterSDK/1.0)';
    ...
    public static function call(UnixConverterContext $ctx, string $fullurl, array $fetchdef): array
    {
