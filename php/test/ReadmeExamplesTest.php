...
// UnixConverter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UnixConverterSDK::test)
...
{
    private const SDK_CLASS = 'UnixConverterSDK';
    ...
    private const SDK_BASE = 'unixconverter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../unixconverter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
