...
// UnixConverter SDK timeout feature
...
class UnixConverterTimeoutFeature extends UnixConverterBaseFeature
{
    ...
    private function _with_timeout(UnixConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UnixConverterContext $_ctx, float $ms): void
    {
        $client = $this->client;
