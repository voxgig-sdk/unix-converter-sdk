...
// UnixConverter SDK netsim feature
...
class UnixConverterNetsimFeature extends UnixConverterBaseFeature
{
    ...
    private function _simulate(UnixConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UnixConverterContext $ctx, array $applied): void
    {
        $client = $this->client;
