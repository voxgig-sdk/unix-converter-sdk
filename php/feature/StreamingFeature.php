...
// UnixConverter SDK streaming feature
...
class UnixConverterStreamingFeature extends UnixConverterBaseFeature
{
    ...
    private function _iterate(UnixConverterResult $result): \Generator
    {
    ...
    private function _streamable(UnixConverterContext $ctx): bool
    {
