...
// UnixConverter SDK rbac feature
...
class UnixConverterRbacFeature extends UnixConverterBaseFeature
{
    ...
    private function _required(UnixConverterContext $ctx): ?string
    {
    ...
    private function _reject(UnixConverterContext $ctx, string $required): void
    {
    ...
    private function _track(UnixConverterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
