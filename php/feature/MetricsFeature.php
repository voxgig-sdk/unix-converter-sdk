...
// UnixConverter SDK metrics feature
...
class UnixConverterMetricsFeature extends UnixConverterBaseFeature
{
    ...
    private function _record(UnixConverterContext $ctx, bool $ok): void
    {
