...
// UnixConverter SDK paging feature
...
class UnixConverterPagingFeature extends UnixConverterBaseFeature
{
    ...
    private function _is_list(UnixConverterContext $ctx): bool
    {
