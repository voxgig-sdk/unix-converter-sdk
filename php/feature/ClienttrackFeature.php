...
// UnixConverter SDK clienttrack feature
...
class UnixConverterClienttrackFeature extends UnixConverterBaseFeature
{
    ...
    public function PostConstruct(UnixConverterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UnixConverter-SDK';
