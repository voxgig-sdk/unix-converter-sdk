...
// UnixConverter SDK idempotency feature
...
class UnixConverterIdempotencyFeature extends UnixConverterBaseFeature
{
    ...
    private function _mutating(UnixConverterContext $ctx): bool
    {
