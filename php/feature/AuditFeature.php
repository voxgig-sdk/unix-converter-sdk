...
// UnixConverter SDK audit feature
...
class UnixConverterAuditFeature extends UnixConverterBaseFeature
{
    ...
    private function _emit(UnixConverterContext $ctx, string $outcome): void
    {
