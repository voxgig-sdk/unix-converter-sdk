# UnixConverter PHP SDK Reference

Complete API reference for the UnixConverter PHP SDK.
...
#### `UnixConverterSDK::test($testopts = null, $sdkopts = null)`
