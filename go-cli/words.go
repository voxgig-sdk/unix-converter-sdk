...
func registerSDKWords(r *eng.Registry, client *sdk.UnixConverterSDK) {
...
func runOp(client *sdk.UnixConverterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
