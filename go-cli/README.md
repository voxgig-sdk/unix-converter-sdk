...
AQL-driven CLI and REPL for the UnixConverter SDK. Positional arguments are
...
./unix-converter-cli list conversion
./unix-converter-cli load 1 conversion
./unix-converter-cli load '{id:1}' conversion
