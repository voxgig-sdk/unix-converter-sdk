...
type Args struct {
	Entity string         `json:"entity" jsonschema:"conversion"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.UnixConverterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "unix-converter_list",
		Description: "List records from UnixConverter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "unix-converter_load",
		Description: "Load a single record from UnixConverter. " +
...
func runOp(client *sdk.UnixConverterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UnixConverterSDK, name string) (sdk.UnixConverterEntity, error) {
	switch strings.ToLower(name) {
	case "conversion":
		return client.Conversion(nil), nil
