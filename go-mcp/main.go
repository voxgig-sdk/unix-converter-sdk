// Command UnixConverter-mcp is an MCP server exposing the UnixConverter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UnixConverter_list  — list records of an entity
//	UnixConverter_load  — load a single record of an entity
//
