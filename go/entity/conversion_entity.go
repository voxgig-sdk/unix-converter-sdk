...
func NewConversionEntity(client *core.UnixConverterSDK, entopts map[string]any) *ConversionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConversionEntity) GetName() string { return e.name }
...
func (e *ConversionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConversionEntity) Deleted() bool {
	return e.deleted
}


func (e *ConversionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConversionEntity(e.client, opts)
}

func (e *ConversionEntity) Data(args ...any) any {
...
func (e *ConversionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Conversion; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConversionEntity) DataTyped(data ...Conversion) Conversion {
	if len(data) > 0 {
		return typedFrom[Conversion](e.Data(asMap(data[0])))
	}
	return typedFrom[Conversion](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Conversion (all fields
// optional at the wire level).
func (e *ConversionEntity) MatchTyped(match ...Conversion) Conversion {
	if len(match) > 0 {
		return typedFrom[Conversion](e.Match(asMap(match[0])))
	}
	return typedFrom[Conversion](e.Match())
}
...
func (e *ConversionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConversionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConversionLoadMatch and returns an Conversion. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ConversionEntity) LoadTyped(reqmatch ConversionLoadMatch, ctrl map[string]any) (Conversion, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Conversion{}, err
	}
	return typedFrom[Conversion](res), nil
}



func (e *ConversionEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ConversionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConversionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConversionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConversionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
