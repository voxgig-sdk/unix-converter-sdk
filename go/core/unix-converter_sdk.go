...
func (sdk *UnixConverterSDK) OptionsMap() map[string]any {
...
func (sdk *UnixConverterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UnixConverterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UnixConverterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnixConverterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UnixConverterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UnixConverterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UnixConverterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UnixConverterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UnixConverterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UnixConverterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *UnixConverterSDK {
	...
	sdk := NewUnixConverterSDK(sdkopts)
	sdk.Mode = "test"
