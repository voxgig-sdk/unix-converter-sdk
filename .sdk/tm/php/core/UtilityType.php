...
// UnixConverter SDK utility type

class UnixConverterUtility
{
    ...
    public static function copy(UnixConverterUtility $src): UnixConverterUtility
    {
        $u = new UnixConverterUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
