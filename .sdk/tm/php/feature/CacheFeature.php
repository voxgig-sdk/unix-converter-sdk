...
// UnixConverter SDK cache feature
...
class UnixConverterCacheFeature extends UnixConverterBaseFeature
{
    ...
    private function _through(UnixConverterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
