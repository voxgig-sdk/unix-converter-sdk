...
// UnixConverter SDK telemetry feature
...
class UnixConverterTelemetryFeature extends UnixConverterBaseFeature
{
    ...
    private function _close(UnixConverterContext $ctx, bool $ok): void
    {
