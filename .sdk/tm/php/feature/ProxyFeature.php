...
// UnixConverter SDK proxy feature
...
class UnixConverterProxyFeature extends UnixConverterBaseFeature
{
    ...
    public function init(UnixConverterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UnixConverterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
