...
// UnixConverter SDK debug feature
...
class UnixConverterDebugFeature extends UnixConverterBaseFeature
{
    ...
    private function _finish(UnixConverterContext $ctx, bool $ok): void
    {
