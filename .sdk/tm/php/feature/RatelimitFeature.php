...
// UnixConverter SDK ratelimit feature
...
class UnixConverterRatelimitFeature extends UnixConverterBaseFeature
{
    ...
    private function _acquire(UnixConverterContext $ctx): void
    {
    ...
    private function _track(UnixConverterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
