...
// UnixConverter SDK utility: graphql
//
...
class UnixConverterGraphql
{
    ...
    // equivalent.
    public static function body(UnixConverterContext $ctx): mixed
    {
    ...
    public static function errors(UnixConverterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
