...
// UnixConverter SDK pipeline test
//
...
{
    private static function utility(): UnixConverterUtility
    {
        return new UnixConverterUtility();
    }
    ...
    private static function ctx(array $over = []): UnixConverterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UnixConverterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UnixConverterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UnixConverterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UnixConverterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UnixConverterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UnixConverterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UnixConverterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UnixConverterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UnixConverterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UnixConverterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UnixConverterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UnixConverterResponse([]),
            'result' => new UnixConverterResult([]),
        ]);
        [, $err] = UnixConverterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UnixConverterSpec([]),
            'response' => null,
            'result' => new UnixConverterResult([]),
        ]);
        [, $err] = UnixConverterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UnixConverterSpec(['step' => 's']),
            'response' => new UnixConverterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UnixConverterResult([]),
        ]);
        [, $err] = UnixConverterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UnixConverterSpec(['step' => 's']),
            'response' => new UnixConverterResponse(self::resp(200, ['v' => 1])),
            'result' => new UnixConverterResult([]),
        ]);
        [, $err] = UnixConverterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UnixConverterSpec(['step' => 's']),
            'response' => new UnixConverterResponse(self::resp(200, ['v' => 2])),
            'result' => new UnixConverterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UnixConverterMakeResponse::call($ctx);
    ...
    {
        $preset = new UnixConverterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UnixConverterSpec([]),
            'response' => new UnixConverterResponse([]),
            'result' => new UnixConverterResult([]),
        ...
        [$got, $err] = UnixConverterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UnixConverterResult([])]);
        [, $err] = UnixConverterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UnixConverterSpec([]), 'result' => null]);
        [, $err] = UnixConverterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UnixConverterSpec(['step' => 's']),
            'result' => new UnixConverterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UnixConverterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UnixConverterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UnixConverterSpec(['step' => 's']),
            'result' => new UnixConverterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UnixConverterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UnixConverterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UnixConverterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UnixConverterSpec([]),
            'result' => new UnixConverterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UnixConverterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UnixConverterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UnixConverterError('boom', 'boom');
        $utility->fetcher = function (UnixConverterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UnixConverterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UnixConverterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UnixConverterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UnixConverterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UnixConverterResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UnixConverterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UnixConverterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UnixConverterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UnixConverterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UnixConverterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UnixConverterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UnixConverterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UnixConverterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UnixConverterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UnixConverterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UnixConverterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UnixConverterResult(['ok' => false])]);
        $this->expectException(UnixConverterError::class);
        UnixConverterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UnixConverterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UnixConverterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UnixConverterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UnixConverterBaseFeature();
        $b = new UnixConverterBaseFeature();
        UnixConverterFeatureAdd::call($ctx, $a);
        UnixConverterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UnixConverterBaseFeature
    {
        $f = new UnixConverterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UnixConverterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UnixConverterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UnixConverterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UnixConverterPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UnixConverterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UnixConverterResponse(['headers' => null]),
            'result' => new UnixConverterResult([]),
        ]);
        UnixConverterResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UnixConverterResultBody::call($ctx);
