...
class UnixConverterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnixConverterTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UnixConverterTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UnixConverterTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
