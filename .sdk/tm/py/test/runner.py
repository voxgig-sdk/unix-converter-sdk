...
class UnixConverterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UnixConverterTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UnixConverterTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UnixConverterTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
