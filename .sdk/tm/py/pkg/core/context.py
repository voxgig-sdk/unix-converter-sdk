...
from projectname_sdk.core.control import UnixConverterControl
...
class UnixConverterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = UnixConverterControl()
        ...
        if isinstance(sp, UnixConverterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UnixConverterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UnixConverterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UnixConverterError(code, msg, self)
