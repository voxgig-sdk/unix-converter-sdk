...
|---|---|---|
| `ts/` | @voxgig-sdk/unix-converter-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/unix-converter-sdk \
      --repository voxgig-sdk/unix-converter-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/unix-converter-sdk` shows it, and
`npm trust revoke @voxgig-sdk/unix-converter-sdk --id=<id>` removes it.
