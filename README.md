...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/unix-converter` | `npm install @voxgig-sdk/unix-converter` |
| Python | `voxgig-sdk-unix-converter` | `pip install voxgig-sdk-unix-converter` |
| PHP | `voxgig-sdk/unix-converter` | `composer require voxgig-sdk/unix-converter` |
| Golang | `github.com/voxgig-sdk/unix-converter-sdk/go` | `go get github.com/voxgig-sdk/unix-converter-sdk/go` |
| Ruby | `voxgig-sdk-unix-converter` | `gem install voxgig-sdk-unix-converter` |
| Lua | `voxgig-sdk-unix-converter` | `luarocks install voxgig-sdk-unix-converter` |
