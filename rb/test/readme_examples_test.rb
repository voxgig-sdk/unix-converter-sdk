...
#      offline in seeded test mode (UnixConverterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "UnixConverter_sdk.rb")
  SDK_CLASS = "UnixConverterSDK"
