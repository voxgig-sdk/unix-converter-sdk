...
local ConversionEntity = {}
ConversionEntity.__index = ConversionEntity


function ConversionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversionEntity)
  self._name = "conversion"
  self._client = client
...
function ConversionEntity:get_name()
  return self._name
end


function ConversionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversionEntity.new(self._client, opts)
end
...
function ConversionEntity:mark_deleted()
  self._deleted = true
end


function ConversionEntity:deleted()
  return true == self._deleted
end


function ConversionEntity:data_set(args)
  if args ~= nil then
...
function ConversionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversionEntity:match_set(args)
  if args ~= nil then
...
function ConversionEntity:match_get()
...
function ConversionEntity:stream(action, args, callopts)
...
function ConversionEntity:_run_op(ctx, post_done)
  local utility = self._utility
