...
function runner.env_override(m)
  local live = runner.getenv("UNIXCONVERTER_TEST_LIVE")
  local override = runner.getenv("UNIXCONVERTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UNIXCONVERTER_TEST_EXPLAIN")
