...
function runner.env_override(m)
  local live = runner.getenv("UNIX_CONVERTER_TEST_LIVE")
  local override = runner.getenv("UNIX_CONVERTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("UNIX_CONVERTER_TEST_EXPLAIN")
