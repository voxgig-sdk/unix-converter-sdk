...
describe("ConversionDirect", function()
  it("should direct-load-conversion", function()
    local setup = conversion_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversion", setup.live and "live" or "unit")
...
function conversion_direct_setup(mockres)
