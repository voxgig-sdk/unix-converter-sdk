...
function envOverride(m) {
    if ('TRUE' === process.env.UNIX_CONVERTER_TEST_LIVE ||
        'TRUE' === process.env.UNIX_CONVERTER_TEST_OVERRIDE) {
    ...
    m.UNIX_CONVERTER_TEST_EXPLAIN = process.env.UNIX_CONVERTER_TEST_EXPLAIN || m.UNIX_CONVERTER_TEST_EXPLAIN;
    return m;
}
