...
(0, node_test_1.describe)('ConversionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UnixConverterSDK({
    ...
    (0, node_test_1.test)('direct-load-conversion', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-conversion', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.UNIX_CONVERTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UnixConverterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['UNIX_CONVERTER_TEST_CONVERSION_ENTID'];
    ...
    const client = new __1.UnixConverterSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ConversionDirect.test.js.map