...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.UNIXCONVERTER_TEST_LIVE ||
    'TRUE' === process.env.UNIXCONVERTER_TEST_OVERRIDE
  ) {
  ...
  m.UNIXCONVERTER_TEST_EXPLAIN = process.env.UNIXCONVERTER_TEST_EXPLAIN || m.UNIXCONVERTER_TEST_EXPLAIN
